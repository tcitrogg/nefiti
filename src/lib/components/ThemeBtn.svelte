...
<button type="button" title="Theme" on:click={handleMode} class={`${style} ${bg} p-1 relative rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 overflow-hidden`}>
{#if isDarkMode}
