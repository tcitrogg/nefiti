  ...
  <section class="w-full h-smscreen md:h-screen overflow-y-auto rounded-scrollbar sm-scrollbar flex">
    ...
    <section class="w-[20%] h-full md:flex hidden items-center justify-center fixed z-50 top-0 left-0">
      <aside class="w-full h-full px-4 py-5 flex flex-col gap-5">
        ...
        <section class="w-full flex flex-col gap-2">
          ...
          <ThemeBtn style="py-1.5 px-3 flex items-center justify- ring-2 ring-transparent focus:ring-main/50 focus:outline-none rounded-lg gap-4 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-900" bg={""} iconSize={"3xl"} text="Mode"/>
        </section>
      </aside>
    </section>
    ...
    <section class="w-full p-2 md:hidden bg-gradient-to-b from-transparent to-neutral-100 dark:to-neutral-950 :backdrop-blur-md fixed z-50 bottom-0 left-0">
      ...
      <section class="flex items-center justify-around relative z-10">
        <a href='/' class="p-1 flex items-center justify-center ring-2ring-main focus:outline-none text-main rounded-full">
          <i class="icon icon-ic_fluent_home_20_filled flex text-4xl"/>
        </a>
        <a href='/library' class="p-1 flex items-center justify-center focus:ring-2 focus:ring-main/70 focus:outline-none rounded-full">
          <i class="icon icon-ic_fluent_library_20_regular flex text-4xl"/>
        </a>
        <a href='#search' class="p-1 flex items-center justify-center focus:ring-2 focus:ring-main/70 focus:outline-none rounded-full">
