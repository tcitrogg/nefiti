...
/>
<section transition:slide={{duration:300}} class="w-full px-3 py-4 flex relative">
  <section class="w-full lg:w-9/12 flex flex-col gap-7 snap snap-y snap-mandatory p-1">
