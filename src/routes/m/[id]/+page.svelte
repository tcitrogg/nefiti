      ...
      <section class="w-full flex md:flex-row flex-col md:gap-4 md:pt-8 lg:pt-14">
        <section class="w-full md:w-4/12">
          <section class="w-full h-96">
            <a href="/" class="py-1 px-1 rounded-full bg-zinc-950 text-zinc-100 dark:bg-zinc-100 dark:text-zinc-950 text-sm font-semibold ring-2 ring-transparent focus:ring-main/50 focus:outline-none flex items-center gap-3">
